  ...
  return (
    <div className="bg-dark full-screen">
      <div className="login-form sign-up-form">
        <h2>Sign Up</h2>
        {showError}
        <form onSubmit={(e) => handleOnSubmit(e, {name, email, password, passwordConfirmation})}>
          <input type="text" placeholder="name" name="name"
            onChange={(e)=> setName(e.target.value)}
            value={name} autoComplete="new-name" required/>
          <input type="email" placeholder="email" name="email"
            onChange={(e)=> setEmail(e.target.value)}
            value={email} autoComplete="new-email" required/>
          ...
          <input type="password" placeholder="password confirmation" name="passwordConfirmation"
            ...
            value={passwordConfirmation} autoComplete="new-password" required/>
...
const mapDispatchToProps = dispatch =>({
  ...
  cleanAuthMessage: obj => dispatch(cleanAuthMessage()),
});
